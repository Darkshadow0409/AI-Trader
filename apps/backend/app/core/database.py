...
def init_db() -> None:
    from app.models.entities import ActiveTradeRecord, AdapterHealthRecord, AlertRecord, Asset, AuditLogRecord, BacktestResult, BacktestRun, CalibrationSnapshot, ForwardValidationRecord, JournalEntry, MacroEvent, ManualFillRecord, MarketBar, NewsItem, OpsActionRecord, PaperLedgerTransactionRecord, PaperRiskDecisionRecord, PaperRiskPolicyRecord, PaperTradeRecord, PaperTradeReviewRecord, PaperWalletRecord, PilotMetricSnapshotRecord, PipelineRun, ReviewTaskRecord, RiskReport, SignalRecord, SimulatedOrderRecord, StrategyRegistryEntry, StrategyStateTransition, TradeTicketRecord, WatchlistItem
