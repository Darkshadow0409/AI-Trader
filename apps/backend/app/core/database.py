...
def init_db() -> None:
    from app.models.entities import ActiveTradeRecord, AdapterHealthRecord, AiBrainEvidenceReviewRecord, AiBrainOperatorNoteRecord, AiBrainQueryRecord, AlertRecord, Asset, AuditLogRecord, BacktestResult, BacktestRun, CalibrationSnapshot, ForwardValidationRecord, JournalEntry, MacroEvent, ManualFillRecord, MarketBar, NewsItem, OpsActionRecord, PaperLedgerTransactionRecord, PaperLoopControlEventRecord, PaperLoopControlStateRecord, PaperLoopProposalRecord, PaperLoopRunRecord, PaperLoopSafetyEventRecord, PaperRiskDecisionRecord, PaperRiskPolicyRecord, PaperTradeRecord, PaperTradeReviewRecord, PaperWalletRecord, PilotMetricSnapshotRecord, PipelineRun, ReviewTaskRecord, RiskReport, SignalRecord, SimulatedOrderRecord, StrategyRegistryEntry, StrategyStateTransition, TradeTicketRecord, WatchlistItem
