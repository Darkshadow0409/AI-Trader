...
const mockPolymarketRelevantMarkets: PolymarketMarketView[] = [
  ...
  },
  {
    ...
    related_assets: ["GOLD"],
    relevance_score: 4.2,
    relevance_reason: "Macro narrative overlap. Solid volume. Near-term expiry.",
...
export const mockPolymarketHunter: PolymarketHunterView = {
  ...
  events: [
    {
      ...
      slug: "bitcoin-above-95000-march-2026",
      status: "active",
      active: true,
      closed: false,
      end_date: "2026-03-31T23:59:00Z",
  ...
  markets: [
    ...
    },
    {
      ...
      event_id: "pm_event_oil",
      event_title: "WTI above $85 after next EIA print?",
      question: "Will WTI crude settle above $85 after the next EIA inventory report?",
      slug: "wti-above-85-after-eia",
      status: "active",
      active: true,
      closed: false,
      ...
      volume: 265000,
      liquidity: 73000,
      recent_activity: 91000,
      open_interest: 88000,
      primary_tag: "Commodities",
      tags: ["Commodities", "Energy", "Macro"],
      category: "commodities",
      outcomes: [
        { label: "Yes", probability: 0.34 },
        { label: "No", probability: 0.66 },
      ],
      source_status: "fixture_fallback",
      source_note: "Polymarket API unavailable; showing fixture fallback.",
      related_assets: ["WTI"],
      relevance_score: 8.2,
      relevance_reason: "Direct wti linkage, asset-specific wording. Solid volume. Active recent trading.",
      url: "https://polymarket.com/event/wti-above-85-after-eia",
    },
    {
      market_id: "pm_market_gold_2400",
      event_id: "pm_event_gold",
